 ...
 */
@Embeddable
public class OutilsPK implements Serializable {
    ...
    public OutilsPK(int idTypeDeProfil, String domaine) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OutilsPK)) {
            return false;
        }
        OutilsPK other = (OutilsPK) object;
    ...
    public String toString() {
        return "com.testeur.OutilsPK[ idTypeDeProfil=" + idTypeDeProfil + ", domaine=" + domaine + " ]";
    }
