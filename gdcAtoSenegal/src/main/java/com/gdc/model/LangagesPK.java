 ...
 */
@Embeddable
public class LangagesPK implements Serializable {
    ...
    public LangagesPK(int idTypeDeProfil, String domaine) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LangagesPK)) {
            return false;
        }
        LangagesPK other = (LangagesPK) object;
    ...
    public String toString() {
        return "com.testeur.LangagesPK[ idTypeDeProfil=" + idTypeDeProfil + ", domaine=" + domaine + " ]";
    }
