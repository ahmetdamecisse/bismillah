 ...
 */
@Embeddable
public class BddPK implements Serializable {
    ...
    public BddPK(int idTypeDeProfil, String domaine) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof BddPK)) {
            return false;
        }
        BddPK other = (BddPK) object;
    ...
    public String toString() {
        return "com.testeur.BddPK[ idTypeDeProfil=" + idTypeDeProfil + ", domaine=" + domaine + " ]";
    }
